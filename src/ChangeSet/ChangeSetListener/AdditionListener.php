...
class AdditionListener extends AbstractListenerAggregate
{
    ...
    {
        $this->listeners[] = $eventManager->attach('registerNew', array($this, 'cascadeCollections'), 100);
        $this->listeners[] = $eventManager->attach('registerNew', array($this, 'cascadeAssociations'), 50);
    }
